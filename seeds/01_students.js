exports.seed = function(knex, Promise) {
  ...
  return knex("old_students")
    .del()
    .then(function() {
      // Inserts seed entries
      return knex("old_students").insert([
        {
          name: "Ben",
          fave_animal:
            "https://kids.nationalgeographic.com/content/dam/kids/photos/animals/Mammals/A-G/cheetah-running.adapt.945.1.jpg",
        ...
        },
        {
          name: "Grant Fogle",
          fave_animal:
            "https://media.mnn.com/assets/images/2017/01/sleeping-bear-log.jpg.838x0_q80.jpg",
        ...
        },
        {
          name: "Jess",
          fave_animal:
            "https://www.popsci.com/sites/popsci.com/files/styles/1000_1x_/public/images/2018/03/baby_platypuses.jpg?itok=KL69Np6v&fc=50,50",
        ...
        },
        {
          ...
          fave_animal:
            "https://www.shoreupdate.com/wp-content/uploads/awpcp/images/mayhemsk9corps-758aa434-large.jpg",
        ...
        },
        {
          name: "Kate",
          fave_animal:
            "https://images.pexels.com/photos/53001/cougar-mountain-lion-puma-concolor-big-cat-53001.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940",
        ...
        },
        {
          name: "Trey",
          fave_animal:
            "https://images-na.ssl-images-amazon.com/images/I/61irQrNjgnL._SY679_.jpg (33 kB)",
        ...
        },
        {
          ...
          fave_animal:
            "https://images.unsplash.com/photo-1510853675132-58241c941e4f?ixlib=rb-0.3.5&ixid=eyJhcHBfaWQiOjEyMDd9&s=9774e7d1ebaa9ac28f3259d4101b1854&auto=format&fit=crop&w=2305&q=80",
          previous_occupation: "Aircraft Mechanic",
          hometown_lat: 39.7293989,
          hometown_long: 104.9930793,
          useless_superpower:
            "Being able to remember the 57th word of every song heard."
        },
        {
          name: "Sonja",
          fave_animal:
        ...
        },
        {
          ...
          fave_animal:
            "https://upload.wikimedia.org/wikipedia/commons/thumb/1/18/Bradypus.jpg/1024px-Bradypus.jpg",
        ...
        },
        {
          ...
          fave_animal:
            "https://cdn.images.express.co.uk/img/dynamic/galleries/x701/156708.jpg",
          previous_occupation: "Military",
          hometown_lat: 39.9526,
          hometown_long: 75.1652,
          useless_superpower:
            "Can give off heat rays only when it's sunny and hot"
        },
        {
          name: "Reid Garner",
          fave_animal:
            "https://takeshape-prod.imgix.net/207c4ff8-bdf4-4529-970e-b992d4539152/dev/2ea87773-8dde-4724-a03c-bab1190a7a04/John%20Marais-%20Murembo.jpg?auto=compress%2Cformat",
          previous_occupation: "Bartender",
          hometown_lat: 33.209,
          hometown_long: 87.569,
          useless_superpower:
            "Being able to always tell the color of the next gumball to pop out of the machine"
        },
        {
          name: "Gary Anderson",
        ...
        },
        {
          name: "Evan Young",
          fave_animal:
            "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQcJFlfaSP80DfWerdu2nIaBu8W5zBP7GA0qz_Vv-CwHwi-dcz9",
        ...
        },
        {
          name: "Josh Scala",
          fave_animal:
            "https://secure.img1-fg.wfcdn.com/im/38103834/resize-h600%5Ecompr-r85/2804/28041725/%2527Proportions+of+the+Human+Figure+%2528Vitruvian+Man%2529%2527+by+Leonardo+Da+Vinci+Graphic+Art+on+Wrapped+Canvas.jpg",
          previous_occupation: "Applications Engineer",
          hometown_lat: 40.959471,
          hometown_long: 74.125202,
          useless_superpower:
            "Can telekinetically move rubbage, but only between two trash recepticles."
        }
      ]);
    });
};
